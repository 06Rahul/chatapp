...
public class UserAdpter extends RecyclerView.Adapter<UserAdpter.viewholder> {
    ...
    public UserAdpter(com.av.avmessenger.MainActivity mainActivity, ArrayList<Users> usersArrayList) {
    ...
    public void onBindViewHolder(@NonNull UserAdpter.viewholder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(mainActivity, com.av.avmessenger.chatwindo.class);
